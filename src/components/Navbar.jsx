...
export const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center p-4 sticky w-full z-0 top-0 bg-black text-white">
      ...
      {open && (
        <div className="sm:hidden fixed top-0 right-0 w-[40%] bg-black h-full z-10 block p-4 transition-all ease-in-out duration-150">
          ...
          <div className="mt-[40px] flex justify-center  flex-col gap-4 max-w-[200px]">
            <Link
              to="login"
              className="bg-orange mx-6 py-1 rounded-lg text-center font-semibold"
            >
              Login
            </Link>
            <Link
