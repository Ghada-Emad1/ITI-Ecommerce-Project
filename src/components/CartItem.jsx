    ...
    return(
        <div className="overflow-auto flex flex-col items-center text-darkGray font-semibold">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <button className="bg-orange text-white px-4 py-2 rounded-lg mt-4 ease-in-out transition-all duration-150 hover:opacity-75" onClick={()=>RemoveItem(Item.id)}>Remove</button>
